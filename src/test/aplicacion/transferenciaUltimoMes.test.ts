...
import { _cuenta, empresaTransferenciaUltimoMes } from "../../infrastructura/controllers/cuentaControllers";
...
describe('transferencias ultimo mes', () => {
    ...
    it('transferencias ultimo mes OK', async () => {
        ...
        const transferenciaEmpresaUltimoMesMock = _cuenta.empresaTransferenciaUltimoMes as MockedFunction<() => Promise<Respuesta>>;
        transferenciaEmpresaUltimoMesMock.mockResolvedValue(respuesta);
        await empresaTransferenciaUltimoMes(res as Response);
        expect(_cuenta.empresaTransferenciaUltimoMes).toHaveBeenCalledWith();
