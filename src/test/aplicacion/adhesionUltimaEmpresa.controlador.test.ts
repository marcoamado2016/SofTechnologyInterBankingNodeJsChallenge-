...
import { _empresa,UltimaAdhesionEmpresa } from "../../infrastructura/controllers/empresaController";
...
describe('Adhesion empresa ultimo mes ', () => {
    ...
    it('adhesion ultima empresa ok', async () => {
        ...
        const adhesionEmpresasUltimoMesMock = _empresa.UltimaAdhesionEmpresa as MockedFunction<() => Promise<Respuesta>>;
        adhesionEmpresasUltimoMesMock.mockResolvedValue(respuesta);
        await UltimaAdhesionEmpresa(res as Response)
        expect(_empresa.UltimaAdhesionEmpresa).toHaveBeenCalledWith();
